function FormOpinions() {
    return (
        <form className="grid  grid-cols-2 gap-x-5 gap-y-3">
              ...
              <button className="bg-custom-bg-pink hover:bg-pink-500 active:bg-pink-600 transition duration-300 justify-self-center font-bold text-xl col-span-2 text-custom-white w-28 p-7 pt-0 pb-1 rounded-xl">
                Send
              </button>
            </form>
    )
