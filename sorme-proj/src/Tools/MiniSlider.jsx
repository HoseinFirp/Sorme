...
function MiniSlider() {
  return (
    <div className="carousel h-52 rounded-box">
      
      <div className="carousel-item flex flex-col w-36 border-r justify-between items-center bg-white">
        <img src={prod1} alt="product" className=" mt-5 max-h-32 mr-auto ml-auto" />
      ...
      <div className="carousel-item flex flex-col w-36 border-r justify-between items-center bg-white">
        <img src={prod2} alt="product" className=" mt-5 max-h-32 mr-auto ml-auto" />
        <div className="flex gap-12 items-center mb-5">
          <p className="bg-custom-bg-pink text-custom-white rounded-xl text-sm pr-2 pl-2">
            25%
          </p>
      ...
      <div className="carousel-item flex flex-col w-36 border-r justify-between items-center bg-white">
        <img src={prod3} alt="product" className=" mt-5 max-h-32 mr-auto ml-auto" />
        <div className="flex gap-12 items-center mb-5">
          <p className="bg-custom-bg-pink text-custom-white rounded-xl text-sm pr-2 pl-2">
            25%
          </p>
      ...
      <div className="carousel-item flex flex-col w-36 border-r justify-between items-center bg-white">
        <img src={prod4} alt="product" className="mt-5 max-h-32 mr-auto ml-auto" />
        <div className="flex gap-12 items-center mb-5">
          <p className="bg-custom-bg-pink text-custom-white rounded-xl text-sm pr-2 pl-2">
            25%
          </p>
      ...
      <div className="carousel-item flex flex-col w-36 border-r justify-between items-center bg-white">
        <img src={prod5} alt="product" className=" mt-5 max-h-32 mr-auto ml-auto" />
        <div className="flex gap-12 items-center mb-5">
          <p className="bg-custom-bg-pink text-custom-white rounded-xl text-sm pr-2 pl-2">
            25%
          </p>
