    ...
    <div className="overflow-x-auto">
      <div className="carousel w-full h-full mt-36">
        <div id="slide1" className="carousel-item  relative w-full">
          <img src={slider1} className="w-full p-16 h-fit ml-auto mr-auto" />
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <img src={slider2} className=" p-16  ml-auto mr-auto" />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#slide1">
              <img src={rArrow} className="w-10" />
            </a>
        ...
        <div id="slide3" className="carousel-item relative w-full">
          <img src={slider3} className="p-16  ml-auto mr-auto" />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#slide2">
              <img src={rArrow} className="w-10" />
            </a>
