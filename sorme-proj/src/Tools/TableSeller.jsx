            ...
            <table className="min-w-full divide-y divide-pink-300">
              <thead className="bg-pink-200">
                <tr>
                  <th
                    scope="col"
                    className="px-6 py-3 c text-xs font-bold text-left text-gray-500 uppercase "
                  >
                    User Name
                  </th>
                  <th
                    scope="col"
                    className="px-6 py-3 min-w-36 text-xs font-bold text-left text-gray-500 uppercase "
                  >
                    Registery Date
                  </th>
                  <th
