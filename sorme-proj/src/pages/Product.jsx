...
function Product() {
  return (
    <div>
      ...
      <div id="main" className="grid grid-cols-2 gap-y-12 gap-x-10 px-16 py-10 pb-20 bg-white justify-around">
        ...
        >
            <div className="flex gap-10 justify-between items-center">
                <p className="line-through font-bold text-4xl text-pink-200">120$</p>
                <p className=" bg-pink-300 rounded-3xl text-white flex self-center px-3 ">25%</p>
        ...
        >
            <div className="flex gap-3 flex-col">
                <div className="flex justify-start items-center gap-3">
                    <img src={homeIcon} className="w-14"/><p>Seller : Sorme</p>
                </div>
                <div className="flex justify-start items-center gap-3">
                    <img src={checkIcon} className="w-14"/><p>Brand : Follero</p>
                </div>
            </div>
            <p className="text-7xl pb-5">|</p>
            <div className="flex items-center gap-3">
                <img src={truckIcon} className="w-14 h-14"/><p>Free shipping<br/> to New York </p>
            </div>
        </div>
      </div>
    </div>
