  ...
  return (
    <div className="h-16 bg-white shadow-black shadow-2xl flex items-center justify-between px-16 pl-20">
      ...
      <div className="flex gap-5 items-center">
        <button className="scale-150 flex gap-1 text-md bg-custom-bg-1 transition duration-300 hover:bg-gray-200 rounded-full border-black p-1  font-bold items-center">
          <HiUser />
        </button>
        ...
        <div className="indicator">
          ...
          <button className="flex gap-1  bg-custom-bg-1 transition duration-300 hover:bg-gray-300 rounded-md border-black p-2  font-bold items-center">
