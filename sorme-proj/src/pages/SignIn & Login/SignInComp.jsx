    ...
    <div className="h-screen flex items-center justify-center bg-white">
      <form>
        <div className="flex flex-col rounded-2xl bg-custom-bg-signin gap-3 items-center">
          ...
          <p className="text-white mt-3">Enter username and password</p>
          <div className="flex gap-2 flex-col">
            ...
            <div className="flex items-center">
              ...
              <img src={hide} className="w-10 -translate-x-full pr-2 " />
            </div>
          </div>
          <div className="flex gap-2">
            <button
              type="submit"
              className="bg-white px-2 py-3 rounded-lg font-bold text-pink-300"
            >
              Login to account
            </button>
          ...
          <div>
            <p className="text-white mt-2 text-sm ">Don&apos;t have an account yet?</p>
