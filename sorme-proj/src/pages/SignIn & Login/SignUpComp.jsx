      ...
      <form>
        <div className="flex glass flex-col rounded-2xl bg-pink-500  gap-3 items-center ">
          <div className="flex items-center mt-5 gap-36 justify-between">
            ...
            <img src={sormenew} onClick={()=>navigate('/')} className="cursor-pointer w-24 " />
          </div>
          ...
          <div>
            ...
            <button className="text-white btn bg-transparent border-none hover:bg-transparent active:text-pink-200 text-lg px-3 w-full py-2 pt-3 mb-3 font-bold ">
              Login
            </button>
          </div>
        </div>
