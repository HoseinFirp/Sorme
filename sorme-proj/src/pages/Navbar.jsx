  ...
  return (
    <div className="z-50 w-full bg-white fixed pb-1">
      ...
      <div className="absolute flex   justify-between  w-full  top-5 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <button className="bg-custom-cream hover:bg-amber-700 transition duration-300 mr-80 text-custom-white rounded-md text-lg p-4 font-bold  pt-0 pb-0">
          Register Now
        </button>
      </div>
      <div className="ml-10 mr-16 mt-3 flex justify-between  items-center">
        <div className="flex items-center ">
          ...
          <form className="flex items-center scale-75">
            <button className=" bg-custom-bg-pink hover:bg-pink-500 transition duration-300  w-7 h-7 items-center text-black rounded-md scale-125 justify-center flex">
              <HiMiniMagnifyingGlass />
            </button>
            <input
              placeholder=" Product search ..."
              className="w-64 h-9  -ml-2 p-2 pl-6 text-pink-600 font-semibold rounded-md  outline-none focus:bg-gray-200 transition duration-300 bg-custom-bg-1"
            />
          </form>
        </div>
        <div className="flex gap-2 items-center ">
          <button className="flex gap-1 text-xs hover:text-pink-700  active:bg-pink-100 text-black border rounded-md border-black p-1 font-bold  items-center">
            Seller
          ...
          <div className="indicator">
            ...
            <button className="flex gap-1 text-xs bg-custom-bg-1 transition duration-300 hover:bg-gray-300 rounded-md border-black p-1  font-bold items-center">
        ...
        <div className="ml-16 mt-3  flex gap-3">
          <div className="dropdown dropdown-bottom">
            <div tabIndex={0} role="button" className=" m-1">
              <button className="flex items-center  text-sm   transition hover:text-pink-700 duration-300 rounded-full px-2  text-black gap-1  font-bold ">
          ...
          <button className="flex items-center text-sm hover:bg-pink-100 hover:border border-white border hover:border-pink-200  transition hover:text-pink-700 duration-300 rounded-full px-2  text-black gap-1">
            Brands
