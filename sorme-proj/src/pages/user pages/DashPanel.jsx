...
function DashPanel() {
  ...
  return (
    <div className="grid mt-20 gap-x-28 gap-y-36 md:grid-cols-1 md:gap-y-16 h-screen  md:my-20 lg:grid-cols-2">
      {path === "user" ? (
        <div className="flex shadow-lg shadow-pink-300 justify-end border-2 border-pink-200 w-48 h-20 border-b-4 relative rounded-xl">
          <img
            src={orders}
            className="absolute  -translate-x-40 -translate-y-1/2 -rotate-12"
          />
      ...
      {path !== "user" && path !== "seller" ? (
        <div className="flex shadow-lg shadow-pink-300 justify-end border-2 border-pink-200 w-48 h-20 border-b-4 relative rounded-xl">
          <img
            src={userpink}
            className="absolute  -translate-x-36 h-24 -translate-y-1/2 "
          />
          <div className="flex mr-4 gap-1 justify-center items-end flex-col">
      ...
      {path === "user" ? (
        <div className="flex shadow-lg shadow-pink-300 justify-end border-2 border-pink-200 w-48 h-20 border-b-4 relative rounded-xl">
          <img
            src={wallet}
            className="absolute  -translate-x-36 -translate-y-1/2 -rotate-12"
          />
          <div className="flex mr-4 gap-1 justify-center items-end flex-col">
