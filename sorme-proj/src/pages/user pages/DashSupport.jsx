...
function DashSupport() {
  const { path, activeTickets } = useContext(UserContext);

  return (
    <div className="flex gap-5 scale-50 md:scale-75 lg:scale-75 xl:scale-100 mx-10 bg-pink-300 bg-opacity-20 p-10 rounded-xl">
