...
function DashSettings() {
  ...
  return (
    <div className="flex flex-col items-center gap-5 p-5 rounded-2xl mx-10 bg-pink-100">
      ...
      <button className="bg-white btn border-none h-10 justify-self-center font-bold active:bg-red-600 col-span-2 text-gray-700 w-24  hover:bg-red-500 transition-all hover:text-white rounded-xl">
        Log out
      </button>
    </div>
  );
