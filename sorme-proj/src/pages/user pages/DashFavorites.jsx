    ...
    <div className="grid grid-cols-1 my-20 mx-10 lg:grid-cols-2 gap-x-5 gap-y-10">
      <div className="flex gap-5  items-center h-44 bg-pink-300 bg-opacity-20 rounded-3xl">
        ...
        <div className="flex flex-col mr-3 gap-14">
          <img src={dislike} className="bg-white min-w-12 h-12  p-2 rounded-xl"/>
          <img src={view} className="bg-white h-12 min-w-12 p-2 rounded-xl"/>
        </div>
      </div>
      <div className="flex gap-5  items-center h-44 bg-pink-300 bg-opacity-20 rounded-3xl">
        <img src={favpic1} className="rounded-3xl h-32 ml-6" />
        ...
        <div className="flex flex-col mr-3 gap-14">
          <img src={dislike} className="bg-white h-12 min-w-12 p-2 rounded-xl"/>
          <img src={view} className="bg-white h-12 min-w-12 p-2 rounded-xl"/>
        </div>
      </div>
      <div className="flex gap-5  items-center h-44 bg-pink-300 bg-opacity-20 rounded-3xl">
